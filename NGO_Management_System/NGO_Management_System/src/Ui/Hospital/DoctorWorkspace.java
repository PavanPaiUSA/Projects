...
public class DoctorWorkspace extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelControl.setBackground(new java.awt.Color(255, 51, 0));
        ...
        panelHome.setBackground(java.awt.SystemColor.textHighlight);
        ...
        panelPatient.setBackground(java.awt.SystemColor.textHighlight);
        panelPatient.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitlePatient.setFont(new java.awt.Font("Rockwell", 1, 30)); // NOI18N
        ...
        panelPatient.add(btnPatientView, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, -1, -1));
        ...
        panelPatient.add(btnPatientDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, -1, -1));
        ...
        panelPatient.add(btnPatientCreate, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 600, -1, -1));
        ...
        panelPatient.add(btnPatientUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));

        panelWork.add(panelPatient, "card3");

        panelEncounter.setBackground(java.awt.SystemColor.textHighlight);
        panelEncounter.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitleEncounter.setFont(new java.awt.Font("Rockwell", 1, 30)); // NOI18N
        lblTitleEncounter.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitleEncounter.setText("HOSPITAL DOCTOR: ENCOUNTER");
        ...
        panelEncounter.add(lblEncounterNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, 110, 20));

        lblEncounterHospital.setText("Hospital");
        panelEncounter.add(lblEncounterHospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 340, 100, 20));

        lblDoctorEncounterUsername.setText("Doctor Username");
        panelEncounter.add(lblDoctorEncounterUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 110, 20));

        lblEncounterPatientUsername.setText("Patient Username");
        panelEncounter.add(lblEncounterPatientUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 400, 110, 20));

        lblEncounterDate.setText("Date");
        panelEncounter.add(lblEncounterDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 430, 110, 20));
        panelEncounter.add(txtEncounterNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 101, -1));

        txtEncounterHospital.setEditable(false);
        txtEncounterHospital.setText("Hospital");
        panelEncounter.add(txtEncounterHospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 340, -1, -1));
        panelEncounter.add(txtEncounterDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 430, 200, -1));

        lblEncounterBP.setText("BP");
        panelEncounter.add(lblEncounterBP, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 460, 110, 20));
        panelEncounter.add(txtEncounterBP, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 460, 200, -1));
        ...
        panelEncounter.add(txtChildrenSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(375, 83, 229, -1));

        lblEncounterTemperature.setText("Temperature");
        panelEncounter.add(lblEncounterTemperature, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 490, 110, 20));
        panelEncounter.add(txtEncounterTemperature, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 490, 200, -1));

        lblEncounterMedicine.setText("Medicine");
        panelEncounter.add(lblEncounterMedicine, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 110, 20));
        panelEncounter.add(txtEncounterMedicine, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 520, 200, -1));

        lblEncounterMedicineQuantity.setText("Medicine Quantity");
        panelEncounter.add(lblEncounterMedicineQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, -1, 20));
        ...
        panelEncounter.add(txtMedicineQuantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 550, 200, -1));

        panelEncounter.add(txtEncounterPatientUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 400, -1, 20));

        txtDocUsername.setEditable(false);
        panelEncounter.add(txtDocUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 370, 72, -1));
        ...
        panelEncounter.add(btnEncounterCreate, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 600, -1, -1));
        ...
        panelWork.add(panelEncounter, "card4");
