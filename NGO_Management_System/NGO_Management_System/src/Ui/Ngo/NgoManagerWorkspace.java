...
public class NgoManagerWorkspace extends javax.swing.JPanel {
    ...
    // Additional check to ensure caretaker selection is valid
    if (caretaker.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Select a caretaker");
        return;
    }

    Children newChild = system.getChildrenList().addChildren();

    newChild.setChildrenId(id);
    newChild.setName(name);
    newChild.setAge(age);
    newChild.setDob(dob);
    newChild.setGender(gender);
    newChild.setRole(role);
    newChild.setCaretaker(caretaker);
