...
public class CaretakerWorkspace extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelHome.add(lblTitle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 66, 1135, -1));

        lblRole.setFont(new java.awt.Font("Segoe UI Emoji", 1, 18)); // NOI18N
        lblRole.setText("Role: Caretaker");
        panelHome.add(lblRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(1012, 116, 139, -1));
        ...
        panelHome.add(btnLogOut, new org.netbeans.lib.awtextra.AbsoluteConstraints(1036, 144, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UiImagesssss/NGO icon.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        panelHome.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1300, 650));

        panelWork.add(panelHome, "card2");

        panelChildren.setBackground(new java.awt.Color(204, 204, 204));
        ...
        panelChildren.add(lblChildrenName, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 450, -1, -1));
        panelChildren.add(txtChildrenName, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 440, 230, -1));

        lblChildrenAge.setText("Age:");
        panelChildren.add(lblChildrenAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 490, -1, -1));
        panelChildren.add(txtChildrenAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 480, 230, -1));

        lblChildrenId.setText("Children Id:");
        panelChildren.add(lblChildrenId, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 400, -1, -1));
        panelChildren.add(txtChildrenId, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 400, 230, -1));

        lblChildrenDob.setText("DOB:");
        panelChildren.add(lblChildrenDob, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 530, -1, 20));
        panelChildren.add(txtChildrenDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 520, 230, -1));

        lblChildrenGender.setText("Gender:");
        panelChildren.add(lblChildrenGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 570, -1, -1));

        cmbChildrenGender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female", "Others" }));
        panelChildren.add(cmbChildrenGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 560, 230, -1));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UiImagesssss/Student2.png"))); // NOI18N
        panelChildren.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1300, 670));

        panelWork.add(panelChildren, "card10");

        panelHealth.setBackground(new java.awt.Color(204, 204, 204));
        panelHealth.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lblTitle6.setFont(new java.awt.Font("Rockwell", 1, 30)); // NOI18N
        lblTitle6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblTitle6.setText("Children Health");
        panelHealth.add(lblTitle6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 730, -1));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UiImagesssss/school login.png"))); // NOI18N
        panelHealth.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 1280, 720));
